  ...
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600">Quản lý lịch khám bệnh</p>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        ...
        <div className="border rounded p-3 text-center">
          <div className="text-2xl font-semibold text-blue-600">{stats.booked}</div>
        ...
        <div className="border rounded p-3 text-center">
          <div className="text-2xl font-semibold text-gray-600">{stats.available}</div>
      ...
      <div className="border rounded overflow-x-auto">
        <h2 className="font-medium p-4 border-b">Lịch ngày {new Date(selectedDate).toLocaleDateString('vi-VN')}</h2>
